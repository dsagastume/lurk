...
//          console.log("click");
	...
	playTune : function(status) {
		...
		var aliado1 = new Media("http://www.lurkapp.com/resources/audio/test/aliado1.mp3",
			function() {
				console.log("Play OK");
			},
		...
		var enemigo1 = new Media("http://www.lurkapp.com/resources/audio/test/enemigo1.mp3",
			function() {
				console.log("Play OK");
			},
		...
		var neutral1 = new Media("http://www.lurkapp.com/resources/audio/test/neutral1.mp3",
			function() {
				console.log("Play OK");
			},
