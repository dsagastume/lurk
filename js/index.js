...
//          console.log("click");
	...
	playTune : function(status) {
		...
		var aliado1 = new Media("/android_asset/www/aliado1.mp3",
			function() {
				console.log("Play OK");
			},
		...
		var enemigo1 = new Media("/android_asset/www/enemigo1.mp3",
			function() {
				console.log("Play OK");
			},
		...
		var neutral1 = new Media("/android_asset/www/neutral1.mp3",
			function() {
				console.log("Play OK");
			},
