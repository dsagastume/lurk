...
//		navigator.splashscreen.fadeOut();
		...
		app.sound.preloadAudio('aliado', 'res/sounds/aliado1.mp3');
		app.sound.preloadAudio('enemigo', 'res/sounds/enemigo1.mp3');
		app.sound.preloadAudio('neutral', 'res/sounds/neutral1.mp3');
