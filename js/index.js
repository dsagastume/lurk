...
//		navigator.splashscreen.fadeOut();
		...
		app.sound.preloadFX('aliado', 'res/sounds/aliado1.mp3');
		app.sound.preloadFX('enemigo', 'res/sounds/enemigo1.mp3');
		app.sound.preloadFX('neutral', 'res/sounds/neutral1.mp3');
